...
import { carsService, reservationsService, entretiensService } from "../../services/api";
...
const STATUS_MAP = {
  ...
  louee: { label: "Louée", color: "#ef4444" },
  loue: { label: "Louée", color: "#ef4444" },
...
function CarDetails() {
  ...
  if (loading) {
    return (
      <div className="cars-page car-details-page">
        <Loader />
      </div>
    );
  }
    ...
    <div className="cars-page car-details-page">
      ...
      <div className="cars-body">
        ...
        <div className="car-details-quick-stats">
          ...
          <div className="car-details-stat-card">
            <div className="stat-icon" style={{ background: "#3b82f6" }}>KM</div>
            <div>
        ...
        <div className="car-details-section">
          ...
          {expenses.length === 0 ? (
            ...
            <div className="table-card">
              <table className="cars-table data-table table-header-sticky">
                <thead>
                  <tr>
                    <th>Date</th>
                    <th>Type</th>
                ...
                <tbody>
                  {reservations.map((r) => {
                    ...
                    return (
                      <tr key={r.id}>
                        <td>
                          <strong>{r.client_nom || r.client_name || 'Client sans nom'}</strong>
                          <br />
                        ...
                        <td style={{ color: "#10b981" }}>{formatMoney(paid)}</td>
                        <td style={{ color: rest > 0 ? "#f59e0b" : "#6b7280" }}>
                          {formatMoney(rest)}
                        </td>
                        <td>
                          <button
