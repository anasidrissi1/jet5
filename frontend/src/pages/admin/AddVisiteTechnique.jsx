...
const AddVisiteTechnique = () => {
  ...
  const fetchCars = useCallback(async () => {
    try {
      const response = await carsService.list();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEditMode) {
        ...
        await visitesTechniquesService.update(visiteToEdit.id, {
        ...
        const promises = selectedVoitures.map(voitureId => 
          visitesTechniquesService.create({
              ...
              <div className="auto-form-grid">
                ...
                <div className="step-content" style={{ margin: '0' }}>
                  ...
                  <div className="form-group">
                    <label className="form-label">
                      Voitures <span style={{ color: '#ef4444' }}>*</span>
                    </label>
                    <MultiSelect
                      options={cars}
                ...
                <div className="step-content" style={{ margin: '0' }}>
                  ...
                  <div className="form-group" style={{ marginBottom: '12px' }}>
                    <FormInput
                      type="date"
                      label={<>Date de Visite <span style={{ color: '#ef4444' }}>*</span></>}
                      name="date_visite"
                  ...
                  <div className="form-group" style={{ marginBottom: '12px' }}>
                    <FormInput
                      type="date"
                      label={<>Date d'Expiration <span style={{ color: '#ef4444' }}>*</span></>}
