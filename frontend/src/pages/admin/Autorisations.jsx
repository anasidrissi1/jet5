...
import { carsService, autorisationsService } from "../../services/api";
...
function Autorisations() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        // Fetch autorisations
        const authRes = await autorisationsService.list();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await autorisationsService.create({
      ...
      // Refresh list
      const res = await autorisationsService.list();
