...
function Entretiens() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const entretienRes = await entretiensService.list();
  ...
  const confirmDelete = async () => {
    ...
    try {
      await entretiensService.delete(pendingDelete.id);

      const res = await entretiensService.list();
                    ...
                    return (
                      ...
                      >
                        ...
                        <td style={{ padding: '16px' }}>
                          <strong style={{ color: '#dc2626', fontSize: '15px', fontWeight: '700', letterSpacing: '0.5px' }}>{car?.immatriculation || '-'}</strong>
                        </td>
                        <td style={{ padding: '16px' }}>
                          <span style={{
                        ...
                        <td style={{ padding: '16px', textAlign: 'right', whiteSpace: 'nowrap', verticalAlign: 'middle' }}>
                          <span style={{ fontSize: '15px', fontWeight: '700', color: '#059669', background: 'rgba(5, 150, 105, 0.12)', padding: '6px 18px', borderRadius: '6px', border: '1px solid rgba(5, 150, 105, 0.35)', display: 'inline-block', minWidth: '90px', textAlign: 'center', lineHeight: '1.5', marginRight: '16px' }}>
                        ...
                        <td style={{ padding: '16px' }}>
                          <div style={{ display: 'flex', gap: '8px', justifyContent: 'center' }}>
                            <button
                              ...
                              style={{ padding: '10px', background: 'linear-gradient(135deg, #06b6d4 0%, #0891b2 100%)', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontSize: '18px', fontWeight: '700', transition: 'all 0.2s', boxShadow: '0 2px 8px rgba(6, 182, 212, 0.3)', display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}
                              onMouseOver={e => { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 4px 12px rgba(6, 182, 212, 0.4)'; }}
                              onMouseOut={e => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 2px 8px rgba(6, 182, 212, 0.3)'; }}
                            >
                            ...
                            <button
                              ...
                              style={{ padding: '10px', background: 'linear-gradient(135deg, #f43f5e 0%, #e11d48 100%)', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontSize: '18px', fontWeight: '700', transition: 'all 0.2s', boxShadow: '0 2px 8px rgba(244, 63, 94, 0.3)', display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}
                              onMouseOver={e => { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 4px 12px rgba(244, 63, 94, 0.4)'; }}
