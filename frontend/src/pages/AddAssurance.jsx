...
function AddAssurance() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const assurRes = await apiClient.get("/cars/assurances/");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEditMode) {
        ...
        await apiClient.put(`/cars/assurances/${assuranceToEdit.id}/`, formDataToSend, {
          headers: {
        ...
        const promises = selectedVoitures.map((voitureId) => {
          ...
          return apiClient.post("/cars/assurances/", formDataToSend, {
            headers: {
              "Content-Type": "multipart/form-data",
            },
          });
  ...
  return (
    <div className="cars-page assurance-dark">
      <PageHeader
