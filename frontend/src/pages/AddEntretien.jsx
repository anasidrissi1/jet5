...
function AddEntretien() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        if (isEditMode) {
          const entretienRes = await apiClient.get(`/cars/entretiens/${id}/`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditMode) {
        await apiClient.put(`/cars/entretiens/${id}/`, dataToSend);
        addNotification("Entretien modifié avec succès", "success");
      } else {
        await apiClient.post("/cars/entretiens/", dataToSend);
              ...
              <div className="step-content" style={{ marginBottom: "20px" }}>
                ...
                <div className="responsive-grid-240">
                  ...
                  <FormInput
                    ...
                    label={
                      <>
                        Date d'entretien <span style={{ color: "var(--color-danger)" }}>*</span>
                      </>
                    }
                    name="date_entretien"
